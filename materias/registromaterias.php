...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO materias (cod_materia, materia) VALUES (%s, %s)",
  ...
  $insertGoTo = "registromaterias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <table width="369" border="1">
    <tbody>
      <tr>
        ...
        <td width="224"><input type="text" name="codmat" id="codmat"></td>
      </tr>
      <tr>
        <td>Nombre de Materia</td>
        <td><input type="text" name="nommat" id="nommat"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
